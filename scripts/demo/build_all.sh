...
python3 scripts/demo/fetch_demo_atlas.py
python3 scripts/demo/run_phoenix.py --demo-atlas "$@"
...
echo "  PHOENIX   -> demo/data_package/per_patient/*/phoenix_*"
echo "  Haiku     -> demo/haiku/"
echo "  GigaTIME  -> demo/gigatime/outputs/"
echo ""
echo "Start UI: bash scripts/run_ui.sh   (HistoGEN Advisor :8080)"
