...
def atlas_path() -> Path:
    """Demo-only precomputed AnnData — not used for inference on new H&E."""
...
def phoenix_weights_dir() -> Path:
    return PHOENIX_WEIGHTS
